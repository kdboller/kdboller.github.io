...
<u><strong>RFM Analyses</strong></u>

<p>In this last section, I’ve included a Recency, Frequency, Monetary Value (RFM) analysis.  While in the course of reviewing effective ways to segment subscribers and after discovering this methodology, I then found <a href="https://github.com/joaolcorreia/RFM-analysis/blob/master/RFM%20Analysis.ipynb" target="_blank">this helpful notebook</a> on Joao Correia’s GitHub.  Here’s a very brief rundown of RFM. </p>
...
<strong>Monetary Value:</strong>  the dollar amount that the user / subscriber has paid in total from all of their purchases during their entire lifetime as a customer.<br>
</p>
