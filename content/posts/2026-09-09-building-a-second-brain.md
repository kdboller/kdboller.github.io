...
**This project is also extensible to all of my work:** a separate skills/ layer at the repo root holds general operating practices that are shared across every other project repo I run as part of both my consulting business and my personal projects. The intent, which I'm still refining, is for a lesson learned in any of my projects not only improves that project, via compounding engineering, but also hardens the baseline for all the others. The ultimate objective is that any new project starts at the current baseline of my entire second brain and the re-learning and re-training of implementation guidelines and best practices for the new project is minimized to the fullest extent.
